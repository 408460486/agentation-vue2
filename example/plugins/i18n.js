...
const messages = {
  en: {
    ...
    'install.nuxt2Desc': 'For Nuxt 2, add CSS to',
    'install.nuxt2Desc2': ':',
    'install.nuxt2Layout': 'Then add the component to',
    ...
    'install.reqZeroDesc': '— No runtime dependencies beyond Vue',
    'install.props': 'Props',
  ...
  zh: {
    ...
    'install.nuxt2': 'Nuxt 2',
    'install.nuxt2Desc': '对于 Nuxt 2，请在',
    'install.nuxt2Desc2': '中添加 CSS：',
    'install.nuxt2Layout': '然后将组件添加到',
