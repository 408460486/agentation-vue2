...
### Added
- Persist settings to localStorage, preserving user preferences after page refresh (output detail, annotation color, auto-clear after copy, block page interactions)
